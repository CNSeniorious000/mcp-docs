...
### 数据和文件系统
- **[文件系统](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem)** - 具备可配置访问控制的安全文件操作
- **[PostgreSQL](https://github.com/modelcontextprotocol/servers/tree/main/src/postgres)** - 支持模式检查的只读数据库访问
...
- **[Fetch](https://github.com/modelcontextprotocol/servers/tree/main/src/fetch)** - 优化为 LLM 使用的网页内容获取与转换
...
### AI 和专用工具
- **[EverArt](https://github.com/modelcontextprotocol/servers/tree/main/src/everart)** - 使用多种模型的 AI 图片生成
...
- **[E2B](https://github.com/e2b-dev/mcp-server)** - 在安全的云沙盒环境执行代码
